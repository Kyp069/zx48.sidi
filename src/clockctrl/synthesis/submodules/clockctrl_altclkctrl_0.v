...
module  clockctrl_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //clockctrl_altclkctrl_0_sub
...
`endif
    ...
    clockctrl_altclkctrl_0_sub  clockctrl_altclkctrl_0_sub_component (
                .ena (ena),
                .inclk (sub_wire2),
                .outclk (sub_wire0));
